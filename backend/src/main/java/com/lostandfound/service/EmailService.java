...
public class EmailService {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(EmailService.class);//This creates a logger so your application can write information to the logs.
    ...
    public EmailService(JavaMailSender mailSender) {
        this.mailSender = mailSender; //Spring creates/provides the JavaMailSender object and injects it into EmailService.
    }
