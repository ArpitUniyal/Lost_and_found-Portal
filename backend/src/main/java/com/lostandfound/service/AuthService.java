...
@Service //@Service tells Spring to create and manage an AuthService bean.
public class AuthService {

    private final StudentRepository studentRepository;  //This is Dependency Injection.
...
private String frontendUrl;
    ...
    public AuthService(
            StudentRepository studentRepository, //Spring sees that AuthService needs
            PasswordEncoder passwordEncoder,     //these four objects and injects them
            JwtService jwtService,              //through the constructor.
    ...
    public AuthResponse register(RegisterRequest request) {//RegisterRequest is a DTO that contains the student ID, name, email, phone number, and password provided by the user during registration.
...
public AuthResponse login(LoginRequest request) { //LoginRequest is a DTO that contains the student ID and password provided by the user during login.

    Student student = studentRepository //If a Student exists, give me the Student. Otherwise give me null.
...
public void forgotPassword(String email) {
    ...
    //If a Student exists, give me the Student. Otherwise give me null.
